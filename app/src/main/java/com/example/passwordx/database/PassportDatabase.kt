...
import com.example.passwordx.util.Constants.DB_NAME
import com.example.passwordx.util.Constants.FAT_NAME
import com.example.passwordx.util.Constants.GOT_DATE
import com.example.passwordx.util.Constants.IMAGE
import com.example.passwordx.util.Constants.LAST_NAME
import com.example.passwordx.util.Constants.LIFE_TIME
import com.example.passwordx.util.Constants.SEX
import com.example.passwordx.util.Constants.TABLE_NAME

class PassportDatabase (context: Context
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val query = "CREATE TABLE $TABLE_NAME " +
                ...
                "$LIFE_TIME TEXT NOT NULL, $SEX TEXT NOT NULL, $IMAGE BLOB NOT NULL)"
        db?.execSQL(query)
    }
    ...
    override fun savePassport(passport: Passport) {
        ...
        contentValues.put(SEX, passport.sex)
